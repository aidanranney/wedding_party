defmodule WeddingPartyWeb.Router do
  ...
  import WeddingPartyWeb.UserAuth
  ...
  scope "/", WeddingPartyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{WeddingPartyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", WeddingPartyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{WeddingPartyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", WeddingPartyWeb do
    ...
    live_session :current_user,
      on_mount: [{WeddingPartyWeb.UserAuth, :mount_current_user}] do
